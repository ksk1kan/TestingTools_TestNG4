package zzz_Gup4_Project7;

import Utility.BaseDriverParameterProject;
...
public class PomElements extends BaseDriverParameterProject {
    public PomElements() {
        PageFactory.initElements(BaseDriverParameterProject.driver , this);
